...
{ 
     ...
     { 
         ...
         { 
             ...
             new List<Food> 
             { 
                 new Food { Title = "Onion Rings", Description = "Description of onion rings goes here", Type = foodtypes.Single(t => t.Name == "Appetizer"), Price = 4.99M, BigImgUrl = "/Assets/images/large/placeholder.gif", SmallImgUrl = "/Assets/images/small/placeholder.gif" },
                 new Food { Title = "Garlic Bread, 3 pieces", Description = "Description of garlic bread goes here", Type = foodtypes.Single(t => t.Name == "Appetizer"), Price = 5.99M, BigImgUrl = "/Assets/images/large/placeholder.gif", SmallImgUrl = "/Assets/images/small/placeholder.gif" },
                 new Food { Title = "Large Pizza, 3 toppings", Description = "Description of large pizza goes here", Type = foodtypes.Single(t => t.Name == "Main Course"), Price = 21.99M, BigImgUrl = "/Assets/images/large/placeholder.gif", SmallImgUrl = "/Assets/images/small/placeholder.gif" },
                 new Food { Title = "Medium Pepperoni Pizza", Description = "Description of medium pepperoni pizza goes here", Type = foodtypes.Single(t => t.Name == "Main Course"), Price = 15.99M, BigImgUrl = "/Assets/images/large/placeholder.gif", SmallImgUrl = "/Assets/images/small/placeholder.gif" },
